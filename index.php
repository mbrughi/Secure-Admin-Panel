...
<body class="g-sidenav-show   bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="../index.php" target="_blank">
        ...
        <span class="ms-1 font-weight-bold text-white">Dashboard Logo</span>
      </a>
    </div>
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0">
      <div class="mx-3">
        <a href="#" target="_blank" class="btn btn-outline-primary mt-4 w-100">Documentation</a>
  ...
  <div class="hidden" id="data"><?php //echo htmlspecialchars(json_encode($user), ENT_QUOTES); // check user info ?></div>
	<script>
